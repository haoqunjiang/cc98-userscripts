...
$(function() {
    // for later use
    var sentMsgURL = "http://www.cc98.org/usersms.asp?action=issend";
    var MSG_RE = /<a href="javascript:;" onclick="window.open('messanger.asp?action=outread&id=(\d+)&sender=[^>]*>[心灵备注]/ig;
